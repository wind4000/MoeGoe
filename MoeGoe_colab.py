...
if __name__ == '__main__':
    model = '/content/drive/MyDrive/softvc-explore/G300.pth'
    config = '/content/drive/MyDrive/softvc-explore/config.json'
    ...
    if False:
        ...
        model = '/content/drive/MyDrive/softvc-explore/hubert-soft.pt'
        from hubert_model import hubert_soft
        hubert = hubert_soft(model)

        while True:
            audio_path = '/content/drive/MyDrive/softvc-explore/v1.flac'
            print_speakers(speakers)
            import librosa
            ...
            target_id = 1
            out_path = '/content/drive/MyDrive/softvc-explore/v1-converted.wav'
